...
public class RecrutadorControllerAdvice {
	...
	@ExceptionHandler(RecrutadorNotFoundException.class)
	public ErrorDTO handleCandidatoNotFound(RecrutadorNotFoundException recrutadorNotFound) {
		ErrorDTO errorDTO= new ErrorDTO();
		errorDTO.setStatus(HttpStatus.NOT_FOUND.value());
		errorDTO.setMessage("Recrutador(es) não encontrado(s).");
	...
	@ExceptionHandler(RecrutadorDuplicadoException.class)
	public ErrorDTO handleCandidatoDuplicado(RecrutadorDuplicadoException recrutadorDuplicado) {
		ErrorDTO errorDTO= new ErrorDTO();
		errorDTO.setStatus(HttpStatus.BAD_REQUEST.value());
		errorDTO.setMessage("Já existe um recrutador cadastrado para este e-mail.");
		errorDTO.setTimestamp(new Date());
		return errorDTO;
	}
